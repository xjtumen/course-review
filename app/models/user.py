...
class Student(db.Model):
  ...
  classes_joined = db.relationship('CourseClass', secondary=join_course, order_by='desc(CourseClass.term)',
                                   backref='students')
...
class Teacher(db.Model):
  ...
  _info_history = db.relationship('TeacherInfoHistory', order_by='desc(TeacherInfoHistory.update_time)',
